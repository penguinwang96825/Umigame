...
class TurtleSystem(ABC):

    def __init__(
        self, tickers, init_account_size=10000, risk_level=2, r_max=0.02,
    ...
    def run(self):
        ...
        self.portfolio = {}
        position = {s: {t: None for t in self.tickers}
    ...
    def get_system_data_dict(self):
        sys_dict = {}
        cols = [
            'units', 'shares', 'entry_price', 'stop_price',
            'entry_N', 'value', 'long'
        ]
...
if __name__ == "__main__":
    ...
    sys = TurtleSystem(tickers, init_account_size=1e4, start='2016-01-01', end='2021-08-25')
    sys.run()
